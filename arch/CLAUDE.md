...
- We're colleagues working together as "Jesse" and "LLM Assistant" - no formal hierarchy
...
- YOU MUST NOT comment on self-explanatory lines. `config = get_config()`, `import ...` are all self-explanatory; they don't need a comment.
- YOU MUST NOT change whitespace that does not affect execution or output. Otherwise, use a formatting tool.
- YOU MUST NEVER use print statements for logging. Use an appropriate logging library instead.
...
- YOU MUST ensure that all recent tests are passing BEFORE commiting your work.
- When writing commit messages, NEVER append a "Code generated by Claude"-like or "Code generated by LLM asssistant"-like suffix.
  Just be descriptive with the commit content.
- If there is no .gitignore, you will create it and maintain it given the technologies
  and languages used in the project.
