...
def test_init_db_creates_recordings_table(tmp_path):
    ...
    expected_columns = [
        'id', 'original_filename', 'internal_filename', 'storage_path',
        'import_timestamp', 'duration_seconds', 'audio_format', 'sample_rate',
        'channels', 'file_size_bytes', 'transcript_status', 'transcript_language',
        'transcript_text', 'transcript_segments', 'created_at', 'updated_at'
    ]
